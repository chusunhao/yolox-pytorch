...
def euler2SO3(roll, pitch, yaw, unit="deg"):
    ...
    R = basic_rotation(yaw, unit, axis="z") @ basic_rotation(pitch, unit, axis="y") @ basic_rotation(roll, unit,
                                                                                                     axis="x")
...
def euler2SO3_left(pitch, yaw, roll):
    ...
    R = np.matrix([[cos_yaw * cos_roll, sin_pitch * sin_yaw * cos_roll - cos_pitch * sin_roll,
                    cos_pitch * sin_yaw * cos_roll + sin_pitch * sin_roll],
                   [cos_yaw * sin_roll, sin_pitch * sin_yaw * sin_roll + cos_pitch * cos_roll,
