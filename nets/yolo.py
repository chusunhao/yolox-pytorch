...
class YOLOXHead(nn.Module):
    def __init__(self, num_classes, width=1.0, in_channels=[256, 512, 1024], act="silu", depthwise=False, ):
        ...
        for i in range(len(in_channels)):
            ...
            self.loc_convs.append(nn.Sequential(*[
                Conv(in_channels=int(256 * width), out_channels=int(256 * width), ksize=3, stride=1, act=act),
                Conv(in_channels=int(256 * width), out_channels=int(256 * width), ksize=3, stride=1, act=act),
            ]))
            self.loc_preds.append(
                nn.Conv2d(in_channels=int(256 * width), out_channels=3, kernel_size=1, stride=1, padding=0)
            )
            ...
            self.ori_preds.append(
                nn.Conv2d(in_channels=int(256 * width), out_channels=9, kernel_size=1, stride=1, padding=0)
            )
